      ...
      <div className="w-full flex flex-col gap-1.5 relative">
        ...
        <div className="relative w-full">
          ...
          <input
            ...
            className={cn(
              "w-full pr-12 py-2.5 rounded-xl border border-gray-300 bg-white text-gray-900 placeholder-gray-400 focus:outline-hidden focus:ring-2 focus:ring-primary focus:border-transparent transition-all duration-200 shadow-xs hover:border-gray-400 disabled:opacity-50 disabled:bg-gray-50",
              icon ? "pl-11" : "pl-4",
